...
export const about = {
  paragraphs: [
    ...
    "At **IBM (ISDL)** I work on **Digital Asset Haven**, an enterprise digital-asset platform, on its on-premises and cloud-native side: Kubernetes, OpenShift, Prometheus, Grafana and microservices.",
